...
contract MEEME is ERC721, ERC721Enumerable, ERC721URIStorage, Ownable {
    ...
    function endBouty() external onlyOwner{
        ...
        for (uint i = 0; i< voteWinners.length; i++){
    ...
    function getPoapContract() public virtual view returns (address) {
        return poapAddress;
    } 
    ...
    function getVoteAddress(uint256 tokenId) public view returns (address[] memory){
