...
contract MEEEMOR is ERC721, ERC721Enumerable, ERC721URIStorage, Pausable, Ownable {
    ...
    function mintToken(uint256 eventId, address to) public whenNotPaused returns (bool) {
        lastId += 1;
